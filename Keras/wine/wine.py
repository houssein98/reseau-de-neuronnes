...
f=open("D:/9RAYA/2nd_semestre_OUVERTURE/PROJET DE RECHERCHE/wine/winequality-white.csv",'r')
...
# On le compile
model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy']) #Notre dataset est catégorisé strictement (1 ou 0) => cateogrical_crossentropy
